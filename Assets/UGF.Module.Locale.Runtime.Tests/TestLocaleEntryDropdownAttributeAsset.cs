...
namespace UGF.Module.Locale.Runtime.Tests
{
    ...
    {
        [LocaleEntryDropdown]
        [SerializeField] private GlobalId m_locale1;
        [LocaleEntryDropdown]
        [SerializeField] private GlobalId m_locale2;
        [LocaleEntryDropdown]
        [SerializeField] private GlobalId m_locale3;
        [LocaleEntryDropdown]
        [SerializeField] private GlobalId m_locale4;
        [LocaleEntryDropdown]
        [SerializeField] private GlobalId m_locale5;
        [LocaleEntryDropdown]
        [SerializeField] private GlobalId m_locale6;
