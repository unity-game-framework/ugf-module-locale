...
{
    internal class LocaleKeyAndValueCollectionDrawer : ReorderableListDrawer
    {
        public string PropertyKeyName { get; }
        public string PropertyValueName { get; }

        public LocaleKeyAndValueCollectionDrawer(SerializedProperty serializedProperty, string propertyKeyName, string propertyValueName) : base(serializedProperty)
        {
